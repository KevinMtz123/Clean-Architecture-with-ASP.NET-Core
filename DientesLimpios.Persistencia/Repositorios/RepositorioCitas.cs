...
namespace DientesLimpios.Persistencia.Repositorios
{
    public class RepositorioCitas:Repositorio<Cita>,IRepositorioCitas
    {
        ...
        {
            return await context.Citas.Where(x=>x.DentistaId == dentistaId && x.EstadoCita == Dominio.Enums.EstadoCita.Programada && 
        ...
        public async Task<IEnumerable<Cita>> ObtenerFiltrado(FiltroCitasDTO filtroCitasDTO)
        {
            ...
            {
                queryable = queryable.Where(x => x.EstadoCita == filtroCitasDTO.EstadoCita);
            }
