...
namespace DientesLimpios.Infraestructura.Notificaciones
{
...

    {
        ...
        public async Task EnviarConfirmacionCita(ConfirmacionCitaDTO cita)
        {
            ...
            Su cita con el Dr (Dra.) {cita.Dentista} el {cita.Fecha.ToString("f", new CultureInfo("es-DO"))} en el consultorio {cita.Consultorio}.
        ...
        public async Task EnviarRecordatorioCita(RecordatorioCitaDTO cita)
        {
            ...
            Le recordamos que tiene cita con el Dr (Dra.) {cita.Dentista} ha sido programada para el {cita.Fecha.ToString("f", new CultureInfo("es-DO"))} en el consultorio {cita.Consultorio}.
